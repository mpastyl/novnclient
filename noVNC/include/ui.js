...
addMouseHandlers: function() {
    ...
    $D("keyboardText").onfocus =  UI.virtKeyText;
    $D("sendCtrlAltDelButton").onclick = UI.sendCtrlAltDel;
    $D("sendEnterButton").onclick = UI.sendEnter;
    $D("noVNC_ctrl_box").onclick = UI.sendCtrl;
    $D("noVNC_alt_box").onclick = UI.sendAlt;
    //$D("noVNC_shift_box").onclick = UI.sendShift;
...
virtKeyText: function(){
    var text = $D('keyboardText').value;
    Util.Debug("$$$$$$ the text i get is : " + text);
    Util.Debug(">> UI.keyboardText: " + text.substr(0,40) + "...");
    UI.rfb.clipboardPasteFrom(text);
    Util.Debug("<< UI.keyboardText");
    //UI.rfb.virtKeyText();
    $D('keyboardText').value = "";
...
updateVisualState: function() {
    ...
    if (connected) {
        ...
        $D('sendEnterButton').style.display = "inline";
        $D('noVNC_ctrl_box').style.display = "inline";
        $D('noVNC_alt_box').style.display = "inline";
        //$D('noVNC_shift_box').style.display = "inline";
        $D('ctrl_label').style.display =  "inline";
        $D('alt_label').style.display =  "inline";
        $D('keyboardText').style.display =  "inline";
        //$D('shift_label').style.display =  "inline";
    } else {
        UI.setMouseButton();
        $D('clipboardButton').style.display = "none";
        $D('showKeyboard').style.display = "none";
        $D('sendCtrlAltDelButton').style.display = "none";
        $D('sendEnterButton').style.display = "none";
        $D('noVNC_ctrl_box').style.display = "none";
        $D('noVNC_alt_box').style.display = "none";
        //$D('noVNC_shift_box').style.display = "none";
        $D('ctrl_label').style.display =  "none";
        $D('alt_label').style.display =  "none";
        $D('keyboardText').style.display =  "none";
        //$D('shift_label').style.display =  "none";
    }
